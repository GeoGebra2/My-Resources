...
def plot_traces_2d(f_2d, x_traces, filename, gamma, stepsize):
	...
	plt.xlabel('x1')
	plt.ylabel('x2')
	plt.title(f'gamma = {gamma}, stepsize = {stepsize}')
	plt.tight_layout()

	fig.savefig(filename)


def plot(f, x_traces, filename, gamma, stepsize, logscale=True):
	fig = plt.figure(figsize=(5,4))
